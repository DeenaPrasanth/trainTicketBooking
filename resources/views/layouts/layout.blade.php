...
<head>
    ...
    <title>{{ array_key_exists('application_name', session('data')) ? session('data')['application_name'] : config('app.name', 'Taxi Appz') }}</title>
    ...
    <div class="navbar navbar-expand-md navbar-dark  navbar-static" style="background-color:#FFD60B">
        <div class="navbar-brand">
            <a href="" class="d-inline-block">
                ...
                <img src="{{array_key_exists('logo', session('data')) ? session('data')['logo'] : asset('backend/global_assets/images/logo_light.png') }}" alt="">
            </a>
        </div>
